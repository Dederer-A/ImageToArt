# Templates for AI Issue workflow

| File           | Required  | Purpose                                                            |
| -------------- | --------- | ------------------------------------------------------------------ |
| `PLAN.md`      | Mandatory | Design and implementation plan created before coding.              |
| `SUMMARY.md`   | Mandatory | High-level summary of the completed work.                          |
